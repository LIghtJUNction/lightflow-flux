...
pub fn define() -> WorkflowSpec {
    workflow("lightflow.flux.image_edit")
        ...
        .input("prompt", "text")
        .input_description("prompt", "Edit prompt sent to the FLUX runtime.")
        ...
        .input_description(
            "strength",
            "Edit strength from source image preservation to full redraw.",
        )
        ...
        .input("count", "integer")
        .input_description("count", "Number of edited images to generate.")
